...
overlay (the diegetic surface, per §5.5). This is the same surface the Camp System's
diamonds will reuse — building it here de-risks camp PR C.
...
## Dependencies
- None blocking. Self-contained. Ship before the Camp System.
