...
> **Generated**: 2026-05-27T20:23:57.952Z
...
| `enterBattleEvent` | battle.html | 42651 | function-decl |
| `proceedToNextBattle` | battle.html | 42113 | function-decl |
...
| Symbol | File | Line | Kind |
|---|---|---|---|
| `rollTrainerTeam` | battle.html | 34429 | function-decl |
| `rollMysteryFigureFinalBossTeam` | battle.html | 34840 | function-decl |
| `makeBuild` | battle.html | 10370 | function-decl |
| `makeWildBuild` | battle.html | 44975 | function-decl |
...
| Symbol | File | Line | Kind |
|---|---|---|---|
| `STORY_BUILD_TIER` | battle.html | 33795 | const-decl |
| `_storyBuildTierForEvent` | battle.html | 33979 | function-decl |
| `_storyDowngradeBuildForTier` | battle.html | 34051 | function-decl |
| `_applyStoryBuildPowerTier` | battle.html | 34177 | function-decl |
| `_storyBuildTierForProfessor` | battle.html | 34037 | function-decl |
...
| `_storyEnemyMechKeys` | battle.html | 33321 | function-decl |
| `_minGuaranteedMechsForEvent` | battle.html | 33448 | function-decl |
...
| Symbol | File | Line | Kind |
|---|---|---|---|
| `enterProfessor` | battle.html | 41258 | function-decl |
...
| `pickStoryRivalSpriteFile` | battle.html | 35033 | function-decl |

## City hub

| Symbol | File | Line | Kind |
|---|---|---|---|
| `enterCity` | battle.html | 38919 | function-decl |
| `renderCityActions` | battle.html | 39042 | function-decl |
...
| Symbol | File | Line | Kind |
|---|---|---|---|
| `_pickStarterPartner` | battle.html | 41200 | function-decl |
| `_bossArcRollLegendary` | battle.html | 44386 | function-decl |
...
| Symbol | File | Line | Kind |
|---|---|---|---|
| `STORY_TUTORIAL_SCENES` | battle.html | 37077 | const-decl |
| `_showStoryTutorialScene` | battle.html | 37310 | function-decl |
| `playStoryTutorial` | battle.html | 37371 | function-decl |
...
| Symbol | File | Line | Kind |
|---|---|---|---|
| `_storyCalcRetreatGoldFee` | battle.html | 39879 | function-decl |
| `refreshStoryGameOverRetreatUI` | battle.html | 40892 | function-decl |
| `acceptRivalLossAndContinue` | battle.html | 43158 | function-decl |

## Tutor / EV trainer / Link / Colress

| Symbol | File | Line | Kind |
|---|---|---|---|
| `enterShop` | battle.html | 46009 | function-decl |
| `enterArtifactShop` | battle.html | 46260 | function-decl |
