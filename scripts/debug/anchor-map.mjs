...
const ANCHORS = [
  ...
  { section: 'Mystery Figure / Professor', symbols: ['enterProfessor', 'mfFirstApproach', '_mfFirstLaunchFight', 'acceptMysteryLossAndContinue'] },
  { section: 'Rival', symbols: ['setRivalStanding', 'getRivalEncounterPhase', 'pickStoryRivalSpriteFile'] },
  { section: 'City hub', symbols: ['enterCity', 'renderCityActions', 'getCurrentCityDisplayName'] },
